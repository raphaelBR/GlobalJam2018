...
part_type_scale(global.PartFire,0.1,0.1);					//This is for the size
...
part_type_life(global.PartFire,1,6);                       //this is its lifespan in steps

global.PartToxin = part_type_create()
part_type_shape(global.PartToxin,pt_shape_ring);            //This defines the particles shape
part_type_size(global.PartToxin,0.1,0.2,0,2);               //This is for the size
part_type_scale(global.PartToxin,0.1,0.1);                  //This is for scaling
...
part_type_life(global.PartToxin,1,6);                       //this is its lifespan in steps
